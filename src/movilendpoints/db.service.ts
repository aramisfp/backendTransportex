...
x.Nombre_Empleado asc`;
 ...
 Archivos_Adjuntos_Cantidad, Vehiculo_Modelo, CONFIGURACION_X_EMPRESA.valor as placa_etiqueta  
    from dbo.F_SEL_ACTIVIDAD_SOLICITUD(0, ${ID_Empleado},1) as x, CONFIGURACION_X_EMPRESA WITH (NOLOCK)
    where ${ID_Empresa_Sesion} in (x.ID_Empresa_Registro, 0) and CONFIGURACION_X_EMPRESA.campo = 'ETIQUETA_VEHICULO_PLACA'
and CONFIGURACION_X_EMPRESA.ID_EMPRESA = x.id_empresa_registro
     order by 
...
convert(integer, viaje_solicitud.carga_cargado) as carga_cargado    ,  solcampo_carga_cargado.activo as solcampo_carga_cargado_act, solcampo_barco_nombre.campo_orden as solcampo_barco_nombre_ord,  solcampo_barco_nombre.obligatorio as solcampo_barco_nombre_obl, 
